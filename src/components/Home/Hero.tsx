...
//       <div className="absolute  inset-0 bg-linear-to-r from-app-green/65 to-transparent "/>
//       <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
//         <div className="max-w-xl xl:pl-10">
//             <span className="inlijne-flex items-center gap-1.5 px-4 py-1.5 text-xs font-semibold text-orange-300 bg-orange-300/10 rounded-full mb-5">
//                 <LeafIcon className="size-3"/> Farm-Fresh & Organic
//             </span>
//             <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-white leading-light mb-5">
...
const Hero = () => {
  return (
    <section className="relative overflow-hidden min-h-[540px] mb-10 rounded-3xl flex items-center">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-app-green/65 to-transparent" />
