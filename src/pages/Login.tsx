...
const Login = () => {
    const [isLoginState, setLogingState] = useState(true);
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-app-text-light">
                        ...
                        <button onClick={() => setLogingState(!isLoginState)} className="text-orange-500 ml-1 font-semibold hover:text-orange-600 transition-colors">
